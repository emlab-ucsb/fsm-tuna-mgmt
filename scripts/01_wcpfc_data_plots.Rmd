---
title: "WCPFC Data Plots: LL Catch Quota VDS Plots"
...
# Directory to save the plots generated in this script
results_dir <- here::here("results", "01-wcpfc-data-plots/")
...
```{r cars}
catch_dat <- read_csv(here::here("data", "edited", "wcpfc_yearbook_dat_tidy_1950_2018_LL_ONLY.csv"))

quota_dat <- read_csv(here::here("data", "edited", "wcpfc_bet_quota_dat_tidy_2014_2020.csv"))
```
...
ggsave(paste0(results_dir, "catch_quota_facet_plot_by_flag_ALL.png"), 
...
ggsave(paste0(results_dir, "catch_quota_facet_plot_by_flag_non_SIDs.png"), 
...
ggsave(paste0(results_dir, "catch_quota_facet_plot_by_flag_SIDs.png"), 
...
ggsave(paste0(results_dir, "catch_quota_facet_plot_by_flag_top12.png"), 
